...
export const api = {
  ...
  registrarBaja: (id, data) => post(`/employees/${id}/baja`, data),
  reactivarEmpleado: (id) => post(`/employees/${id}/reactivar`, {}),
  listBajas: () => request("/employees/bajas"),
  ...
  importarTallesUniforme: (file) => importarArchivo("/employees/importar-talles-uniforme", file),
  importarEntregasUniforme: (file) => importarArchivo("/employees/importar-entregas-uniforme", file),

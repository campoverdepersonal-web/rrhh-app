...
const TIPOS = [
  ...
  },
  {
    ...
    descripcion: "Para reportes con una fila por cada competencia evaluada (ej. exportados de una encuesta). Las filas que compartan Legajo + Fecha + Evaluador se agrupan como una sola evaluación con todas sus competencias. El puntaje total se calcula solo a partir de la Respuesta — no hace falta (ni se usa) ningún número de puntaje.",
    columnas: ["Legajo — debe existir en el sistema", "Fecha de respuesta, Evaluador — obligatorios", "Título de la competencia — nombre + \"nivel N\" (ej: \"Orientación al cliente nivel 2\")", "Categoría — Competencia blanda o técnica (informativo, opcional)", "Respuesta — Malo, Regular, Bueno o Muy Bueno/Excelente"],
    plantilla: () => descargarPlantilla("plantilla-evaluaciones-competencias.xlsx", "Competencias evaluadas", [
      { "Legajo": "L-0001", "Fecha de respuesta": "01/06/2026", "Evaluador": "Ana Torres", "Título de la competencia": "Orientación al Cliente nivel 2", "Categoría": "Competencia blanda", "Respuesta": "Bueno" },
      { "Legajo": "L-0001", "Fecha de respuesta": "01/06/2026", "Evaluador": "Ana Torres", "Título de la competencia": "Trabajo en Equipo y Colaboración nivel 2", "Categoría": "Competencia blanda", "Respuesta": "Regular" },
    ], [10, 16, 16, 40, 20, 14]),
